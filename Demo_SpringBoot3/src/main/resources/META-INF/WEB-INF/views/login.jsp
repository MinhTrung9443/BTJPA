	...
	<div class="content-form-page">
		<div class="row">
			...
			<div class="col-md-7 col-sm-7">
				<form action="/RegisterLogin/login" method="post" class="form-horizontal form-without-legend" role="form">
					...
					<div class="row">
						<div class="col-lg-8 col-md-offset-4 padding-left-0">
							<a href="/RegisterLogin/views/forgot.jsp">Forget Password?</a>
						</div>
					</div>
					<div class="row">
						<div
